...
```sh
  cd enumerable
  git clone https://github.com/samuelmoiwa/OOP-school-library
```
...
This project is [MIT](https://github.com/samuelmoiwa/OOP-school-library/blob/create_cleases/MIT.md) licensed.
